...
public class GroupModel {
    public static int getNumberOfModelGroupIds(final int deviceId, int modelNo) {
        ...
        RxBus.getDefaultInstance().post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.GROUP_GET_NUMBER_OF_MODEL_GROUP_IDS, data));
        return id;
    }
    ...
    public static int setModelGroupId(final int deviceId, int modelNo, int groupIndex, int instance, int groupId) {
        ...
        RxBus.getDefaultInstance().post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.GROUP_SET_MODEL_GROUP_ID, data));
        return id;
    }
    ...
    public static int getModelGroupId(int deviceId, int modelNo, int groupIndex) {
        ...
        data.putInt(MeshConstants.EXTRA_MODEL_NO, modelNo);
        data.putInt(MeshConstants.EXTRA_GROUP_INDEX, groupIndex);
        RxBus.getDefaultInstance().post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.GROUP_GET_MODEL_GROUP_ID, data));
        return id;
    }

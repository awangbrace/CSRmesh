...
public class ConfigModel {
    ...
    public static int getInfo(final int deviceId, DeviceInfo infoType) {
        ...
        RxBus.getDefaultInstance().post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.CONFIG_GET_INFO, data));
        return id;
    }
    ...
    public static void setDeviceId(int deviceId, long uuidHash, final int newDeviceId) {
        ...
        RxBus.getDefaultInstance().post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.CONFIG_SET_DEVICE_IDENTIFIER, data));
    }
    ...
    public static int getParameters(final int deviceId) {
        ...
        data.putInt(MeshLibraryManager.EXTRA_REQUEST_ID, id);
        data.putInt(MeshConstants.EXTRA_DEVICE_ID, deviceId);
        RxBus.getDefaultInstance().post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.CONFIG_GET_PARAMETERS, data));
        return id;
    }
    ...
    public static int setParameters(final int deviceId, int txInterval, int txDuration, int rxDutyCycle, int txPower, int ttl) {
        ...
        RxBus.getDefaultInstance().post(new MeshRequestEvent(MeshRequestEvent.RequestEvent.CONFIG_SET_PARAMETERS, data));
        return id;
    }

...
/**
 * Progress bar determinate with material design style.
 */
public class ProgressBarDeterminateMaterial extends CustomViewMaterial {
    ...
    public ProgressBarDeterminateMaterial(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttributes(attrs);
    }

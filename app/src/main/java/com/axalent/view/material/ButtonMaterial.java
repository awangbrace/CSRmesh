...
/**
 * This view represents a button view with material design style.
 */
public abstract class ButtonMaterial extends CustomViewMaterial {
    ...
    public Bitmap makeCircle() {
        Bitmap output = Bitmap.createBitmap(
                getWidth() - MaterialUtils.dpToPx(6, getResources()), getHeight()
                        - MaterialUtils.dpToPx(7, getResources()), Config.ARGB_8888);

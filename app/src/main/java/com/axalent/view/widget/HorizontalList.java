...
public class HorizontalList extends AdapterView<ListAdapter> implements ViewTreeObserver.OnTouchModeChangeListener {
	 ...
	 private static final String LOGTAG = "TwoWayView";
	    ...
	    public interface OnScrollListener {
	         ...
	         */
	        public void onScroll(HorizontalList view, int firstVisibleItem, int visibleItemCount,
								 int totalItemCount);
	    }
...
//	        initializeScrollbars(a);
	    ...
	    public boolean showContextMenuForChild(View originalView) {
	        ...
	        if (longPressPosition >= 0) {
	            ...
	            if (listener != null) {
	                handled = listener.onItemLongClick(HorizontalList.this, originalView,
	    ...
	    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
	        ...
	        event.setClassName(HorizontalList.class.getName());
	    }
	    ...
	    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
	        ...
	        info.setClassName(HorizontalList.class.getName());
	    ...
	    private boolean performLongPress(final View child,
	        ...
	        OnItemLongClickListener listener = getOnItemLongClickListener();
	        if (listener != null) {
	            handled = listener.onItemLongClick(HorizontalList.this, child,
	                    longPressPosition, longPressId);
	        }

	        if (!handled) {
	            mContextMenuInfo = createContextMenuInfo(child, longPressPosition, longPressId);
	            handled = super.showContextMenuForChild(HorizontalList.this);
	        }
	    ...
	    private class AdapterDataSetObserver extends DataSetObserver {
	        ...
	        public void onChanged() {
	            ...
	            if (HorizontalList.this.mHasStableIds && mInstanceState != null
	                    && mOldItemCount == 0 && mItemCount > 0) {
	            	HorizontalList.this.onRestoreInstanceState(mInstanceState);
	                mInstanceState = null;
	            } else {
	                rememberSyncState();
	            }
	        ...
	        public void onInvalidated() {
	            ...
	            if (HorizontalList.this.mHasStableIds) {
	                // Remember the current state for the case where our hosting activity is being
	                // stopped and later restarted
	                mInstanceState = HorizontalList.this.onSaveInstanceState();
	            }
